...
### Color Palette (Custom Theme) - WCAG 2.1 AA Compliant

```css
/* Base Theme Colors - Light Mode */
:root {
  --background: 30 43% 90%; /* hsla(30, 43%, 90%, 1) - #f0e5d9 */
  --foreground: 30 12% 16%; /* hsla(30, 12%, 16%, 1) - #2f2a25 */
  --card: 30 43% 90%; /* hsla(30, 43%, 90%, 1) - #f0e5d9 */
  --card-foreground: 30 12% 16%; /* hsla(30, 12%, 16%, 1) - #2f2a25 */
  --popover: 30 43% 90%; /* hsla(30, 43%, 90%, 1) - #f0e5d9 */
  --popover-foreground: 30 12% 16%; /* hsla(30, 12%, 16%, 1) - #2f2a25 */
  --primary: 139 35% 35%; /* hsla(139, 35%, 35%, 1) - #4a7c5d - WCAG AA Compliant */
  --primary-foreground: 0 0% 100%; /* hsla(0, 0%, 100%, 1) - #ffffff */
  --secondary: 30 33% 80%; /* hsla(30, 33%, 80%, 1) - #d4c2b2 */
  --secondary-foreground: 30 12% 16%; /* hsla(30, 12%, 16%, 1) - #2f2a25 */
  --muted: 30 40% 87%; /* hsla(30, 40%, 87%, 1) - #e3d5c5 */
  --muted-foreground: 30 12% 16%; /* hsla(30, 12%, 16%, 1) - #2f2a25 */
  --accent: 139 35% 35%; /* hsla(139, 35%, 35%, 1) - #4a7c5d - Same as primary */
  --accent-foreground: 0 0% 100%; /* hsla(0, 0%, 100%, 1) - #ffffff */
  --destructive: 0 84% 50%; /* hsla(0, 84%, 50%, 1) - #dc2626 - WCAG AA Compliant */
  --destructive-foreground: 0 0% 100%; /* hsla(0, 0%, 100%, 1) - #ffffff */
  --border: 30 33% 80%; /* hsla(30, 33%, 80%, 1) - #d4c2b2 */
  --input: 30 40% 87%; /* hsla(30, 40%, 87%, 1) - #e3d5c5 */
  --ring: 139 35% 35%; /* hsla(139, 35%, 35%, 1) - #4a7c5d */
  --radius: 0.5rem;

  /* FoodyLog Rating Colors - WCAG AA Compliant */
  --rating-excellent: 139 45% 28%; /* hsla(139, 45%, 28%, 1) - #366142 - Dark green */
  --rating-great: 139 40% 30%; /* hsla(139, 40%, 30%, 1) - #3d6b4a - Dark green */
  --rating-good: 45 85% 27%; /* hsla(45, 85%, 27%, 1) - #826907 - Dark yellow */
  --rating-poor: 25 90% 35%; /* hsla(25, 90%, 35%, 1) - #b84a00 - Dark orange */
  --rating-bad: 0 84% 42%; /* hsla(0, 84%, 42%, 1) - #c41c1c - Dark red */
}

/* Dark Mode - WCAG 2.1 AA Compliant */
.dark {
  --background: 24 7% 12%; /* hsla(24, 7%, 12%, 1) - #1e1b1a */
  --foreground: 30 43% 90%; /* hsla(30, 43%, 90%, 1) - #f0e5d9 */
  --card: 24 7% 12%; /* hsla(24, 7%, 12%, 1) - #1e1b1a */
  --card-foreground: 30 43% 90%; /* hsla(30, 43%, 90%, 1) - #f0e5d9 */
  --popover: 24 7% 12%; /* hsla(24, 7%, 12%, 1) - #1e1b1a */
  --popover-foreground: 30 43% 90%; /* hsla(30, 43%, 90%, 1) - #f0e5d9 */
  --primary: 139 45% 35%; /* hsla(139, 45%, 35%, 1) - #3f8653 - WCAG AA Compliant */
  --primary-foreground: 0 0% 100%; /* hsla(0, 0%, 100%, 1) - #ffffff */
  --secondary: 34 12% 22%; /* hsla(34, 12%, 22%, 1) - #453f3b */
  --secondary-foreground: 30 43% 90%; /* hsla(30, 43%, 90%, 1) - #f0e5d9 */
  --muted: 28 9% 16%; /* hsla(28, 9%, 16%, 1) - #2a2522 */
  --muted-foreground: 30 43% 90%; /* hsla(30, 43%, 90%, 1) - #f0e5d9 */
  --accent: 139 45% 35%; /* hsla(139, 45%, 35%, 1) - #3f8653 - Same as primary */
  --accent-foreground: 0 0% 100%; /* hsla(0, 0%, 100%, 1) - #ffffff */
  --destructive: 0 84% 50%; /* hsla(0, 84%, 50%, 1) - #dc2626 - WCAG AA Compliant */
  --destructive-foreground: 0 0% 100%; /* hsla(0, 0%, 100%, 1) - #ffffff */
  --border: 34 12% 22%; /* hsla(34, 12%, 22%, 1) - #453f3b */
  --input: 28 9% 16%; /* hsla(28, 9%, 16%, 1) - #2a2522 */
  --ring: 139 45% 35%; /* hsla(139, 45%, 35%, 1) - #3f8653 */

  /* FoodyLog Rating Colors - Dark Mode Optimized */
  --rating-excellent: 139 35% 45%; /* hsla(139, 35%, 45%, 1) - #53ac6f - Brighter for dark mode */
  --rating-great: 139 40% 42%; /* hsla(139, 40%, 42%, 1) - #519467 - Brighter for dark mode */
  --rating-good: 45 93% 55%; /* hsla(45, 93%, 55%, 1) - #f7c222 - Brighter yellow */
  --rating-poor: 25 95% 60%; /* hsla(25, 95%, 60%, 1) - #fa8938 - Brighter orange */
  --rating-bad: 0 84% 65%; /* hsla(0, 84%, 65%, 1) - #f15b5b - Brighter red */
}
...
Our color system achieves **100% WCAG 2.1 AA compliance** with the following contrast ratios:

#### Light Mode
- Body text: **11.69:1** (Excellent)
- Primary buttons: **5.28:1** (AA Compliant)
- Secondary buttons: **9.21:1** (Excellent)
- All rating colors: **4.5:1+** (AA Compliant)

#### Dark Mode
- Body text: **13.45:1** (Excellent)
- Primary buttons: **4.8:1** (AA Compliant)
- Secondary buttons: **9.26:1** (Excellent)
- All rating colors: **4.5:1+** (AA Compliant)
...
│                                     │
│    Styled with FoodyLog theme       │
│    (warm colors, food-focused)      │
│                                     │
└─────────────────────────────────────┘
```
...
- Rating: Star icon + number, using rating color system
...
- Color gradient based on rating value using our rating color system:
  - Excellent (9-10): `--rating-excellent`
  - Great (7-8): `--rating-great`
  - Good (5-6): `--rating-good`
  - Poor (3-4): `--rating-poor`
  - Bad (1-2): `--rating-bad`
...
- All text meets WCAG AA contrast ratios (4.5:1 minimum for normal text)
